...
"Speed_11": {"suspension": 0.78, "gearing": 0.83, "brakes": 0.68, "top_speed": 0.99},
"Speed_12": {"suspension": 0.77, "gearing": 0.82, "brakes": 0.67, "top_speed": 0.98},
"Speed_13": {"suspension": 0.76, "gearing": 0.81, "brakes": 0.66, "top_speed": 0.97},
"Speed_14": {"suspension": 0.75, "gearing": 0.8, "brakes": 0.65, "top_speed": 0.96},
"Speed_15": {"suspension": 0.74, "gearing": 0.79, "brakes": 0.64, "top_speed": 0.95}
}
...
self.controller.press_key(action_str)
if action_str == "RClick":
self.controller.move_mouse(random.randint(-20, 20), random.randint(-20, 20))

def calculate_reward(self, observation):
return 1.0 if np.mean(observation) > 80 else -1.0

def execute_command(self, params):
if params.get("task") == "fly_plane":
plane_type = params.get("plane_type", "F16")
print(f"Flying {plane_type}")
self.controller.press_key("W")
self.controller.move_mouse(0, -50)
time.sleep(5)
